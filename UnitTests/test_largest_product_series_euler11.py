...
class MatrixTest(unittest.TestCase):
    ...
    def test_non_list_matrix(self):
        ...
        # matrix data must be array/list. If not, throw.
        try:
            Matrix(matrix_data)
    ...
    def test_largest_Euler_matrix(self):
        matrix_data = [
        ...
        (max_series, max_product) = matrix.greatest_product_in_series(4)
        self.assertEqual(len(set(max_series)) - len(set([66, 91, 88, 97])), 0)
        self.assertEqual(max_product, 51267216)
